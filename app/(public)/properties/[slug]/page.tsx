...
import { mockPropertyDetails, getRelatedProperties } from '@/lib/mock-data'
...
export default function PropertyDetailsPage({
  ...
  // TODO: Check accessLevel from server session
  const [accessLevel] = useState<AccessLevel>('GUEST')
  const [upgradeModalOpen, setUpgradeModalOpen] = useState(false)
  const [saved, setSaved] = useState(false)

  // TODO: Replace with API call to /api/properties/[slug]
  const property: PropertyDetails = {
    ...mockPropertyDetails,
    // Simulate unlocked data for UNLOCKED/SUBSCRIBER
    ...(accessLevel === 'UNLOCKED' || accessLevel === 'SUBSCRIBER'
      ? {
          address: 'Flat 304, Krishna Apartments, Tilakwadi',
          latitude: 15.8497,
          longitude: 74.4977,
  ...
  const relatedProperties = getRelatedProperties(property.id, property.propertyType)
